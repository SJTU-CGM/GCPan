...
<div class="page-header">
   <h1>About 3K Rice Pan-genome</h1>
</div>
...
<div class="page-header">
	...
	<section id="table">
		...
		<h3>Rice Accession Table</h3>
		<p>In the rice accession information table, users can filter the results by selecting browse options such as categories, geological regions and sequencing depth status (high/low). Attention: the result is the intersection of all the options. A summary table can be generated for filtered results.</p>
		<img src="pic/manualPics/riceTable1.PNG" alt="" style="width:800px">
        
	    <img src="pic/manualPics/riceTable2.PNG" alt="" style="width:800px">
        <p>Figure 9. Usage of rice accession table.</p>
